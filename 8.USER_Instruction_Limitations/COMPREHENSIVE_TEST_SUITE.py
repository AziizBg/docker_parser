#!/usr/bin/env python3
"""
Compares USER validation: flags negative ids and non-integer ids in enhanced parser.
"""
import sys
...
def main():
    print("\n== USER LIMITATIONS - COMPARISON ==")
    df = """FROM ubuntu:latest
USER nonexistentuser
USER 999999
USER user:invalidgroup
USER -1:1000
USER app:dev:abc:-2
"""
    print("\nTest Dockerfile:\n```dockerfile\n" + df + "\n```")
    print("Explanation: Enhanced parser annotates validation issues for uid/gid negativity and non-integers.")
